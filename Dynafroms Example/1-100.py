#This problem demonstrates a simple way to solve the problem if someone is given an array in any order numbers 1-100 it will return that missing number
...
for i in range (len(arr)):
	expectedSum += arr[i]
print "Expected sum of array containing numbers 1-100 is:",expectedSum
...
print "The missing number is", expectedSum - newArraySum
